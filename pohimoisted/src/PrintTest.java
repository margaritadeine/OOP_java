public class PrintTest {
    public static void main(String[] args) {
       ...
       Integer kontrolltoo = printer1.prindi(105);
        System.out.println(" Printisin kontrolltöö jaoks" + kontrolltoo + " paberi lehte ja printimiseks on jäänud " + printer1.getPaberPrintimiseks() + " paberi lehte ");
